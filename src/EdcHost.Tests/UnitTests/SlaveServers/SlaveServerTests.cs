...
public class SlaveServerTests
{
    ...
    [Fact]
    public void SlaveServer_DoNothing_CorrectlyInitialized()
    {
        string[] portNameList = new string[] { "COM1", "COM2" };
        int[] baudRateList = new int[] { 9600, 9600 };
        SlaveServer slaveServer = new SlaveServer(portNameList, baudRateList);
        Assert.Equal(,slaveServer. _serialPorts)
